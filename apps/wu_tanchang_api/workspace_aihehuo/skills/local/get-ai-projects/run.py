...
"""Script to call the get-ai-projects API."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Fetch aihehuo project list.")
    ...
    url = f"https://www.aihehuo.com/ai/projects.{args.format}"
    params = {
        "page": args.page,
        "per": args.per,
    }
    ...
    try:
        ...
        print(f"Error calling get-ai-projects: {e}", file=sys.stderr)
        sys.exit(1)
