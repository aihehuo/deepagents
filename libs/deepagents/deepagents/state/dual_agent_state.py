...
class DualAgentState(AgentState):
    ...
    partner_query: NotRequired[str]
    """Partner search query generated by expert agent.
    
    A 10-20 word Chinese sentence/phrase describing the ideal partner
    based on the business idea and needs. Used to search for potential
    partners on the AI He Huo platform.
    
    Example: "寻找有AI技术背景的创业者，希望合作开发教育科技产品"
    """
    
    partner_search_results: NotRequired[list[dict[str, Any]]]
